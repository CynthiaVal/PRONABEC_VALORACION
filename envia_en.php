...
<head>
    ...
    <title>Encuesta Enviada - Pronabec </title>
...
?>
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-8  text-center">
                    <h2 class="section-heading">ENCUESTA DE SATISFACCIÓN AL USUARIO - PRONABEC TACNA</h2>
                    <hr class="light">
   ...
   <section class="bg-primary" >
    ...
    <script>
    function r() { location.href="encuesta.php" } 
    setTimeout ("r()", 5000);
</script>
</body>
